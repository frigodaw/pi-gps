...
typedef struct Gps_readoutData_Tag
{
    ...
    uint8 bufferPtr[GPS_SENTENCES];                                          //helper pointer to Gps_storageBuffer
} Gps_readoutData_T;
...
static Gps_detailedData_T Gps_data[GPS_STOREDRECORDS];              //structure with detailed gps data
